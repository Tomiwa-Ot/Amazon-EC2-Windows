...
Set-Variable modulePath -Option Constant -Scope Local -Value (Join-Path $rootPath -ChildPath "Module")
Set-Variable setPasswordScriptPath -Option Constant -Scope Local -Value (Join-Path $modulePath -ChildPath "Scripts\New-RandomPassword.ps1")
Set-Variable confirmPasswordScriptPath -Option Constant -Scope Local -Value (Join-Path $modulePath -ChildPath "Scripts\Confirm-Password.ps1")
Set-Variable invokeNetUserScriptPath -Option Constant -Scope Local -Value (Join-Path $modulePath -ChildPath "Scripts\Invoke-NetUser.ps1")

$localAdminName = $args[0]

. "$setPasswordScriptPath"
. "$confirmPasswordScriptPath"
. "$invokeNetUserScriptPath"

$newPassword = New-RandomPassword

Invoke-NetUser -Username $localAdminName -Password $newPassword -Flags @("/ACTIVE:YES","/LOGONPASSWORDCHG:NO","/EXPIRES:NEVER","/PASSWORDREQ:NO")

# SIG # Begin signature block
# MIIfJgYJKoZIhvcNAQcCoIIfFzCCHxMCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCg+pZu93BoLjq7
# +Dg/1x1p0uxJVVOFkg8+oSvcV5+Iv6CCDlUwggawMIIEmKADAgECAhAIrUCyYNKc
...
# CQQxIgQg16UUD0Pv9Oxn5XjhRiswD4vei3iBEK8ezdOlna9Im/gwDQYJKoZIhvcN
# AQEBBQAEggGAqxOckV10nGfEfYi1Ycv16Tj8IMhCHKWGyqwV/vThM2u2lOXV/fjA
# 1+4CH39LrXfn4Dn/5SGHHfAEU+6IVe4hGtR/Yk6rOORFlnJHAR32GxFiaHWSUmJM
# +RyjYdxoA6RqHntWEPo362Z+aSNLvjrMEGgXRLcKtdWThKu5898tQDHgFLMX2TsX
# 2T6y70XGoSmq9SI3EKLwvSlx6ZowgOAdP224jTYMYS3F0o6Jv2d+JRlYgekaoh8p
# dD6E4fGKORfWiwScaBKmSezgbf2tr6Txbe4/AHUewiYdJ8NTYgFUHP4Zm6BgnjPn
# xMZWaCsLu//kPREIyMrutaBWcoHG+oFKTo7RBMVArVCYMpfsiiuNGNQxNkdNarlG
# rOTMjaMvlEzXLMCgbnZpLpLz3dpySuwPfYZAvcWVm1uLClSiLrjUT3nFOL207wqz
# /ZHOWL0/NvoAHRXKO3mDGk7wHuqqRj22X9U4C6DEiFYWqly3BcQC6ztDXskLWZxI
# KYYHBZAQgjpjoYINfTCCDXkGCisGAQQBgjcDAwExgg1pMIINZQYJKoZIhvcNAQcC
# oIINVjCCDVICAQMxDzANBglghkgBZQMEAgEFADB3BgsqhkiG9w0BCRABBKBoBGYw
# ZAIBAQYJYIZIAYb9bAcBMDEwDQYJYIZIAWUDBAIBBQAEICJZDXoD1C4uv9pKGT92
# fscsU+owRBvjpFDeQ9G0ngTCAhA/o2KbapxLxcqoEnnKb/UIGA8yMDIyMDEzMTE4
# NTQyOVqgggo3MIIE/jCCA+agAwIBAgIQDUJK4L46iP9gQCHOFADw3TANBgkqhkiG
...
# DxcNMjIwMTMxMTg1NDI5WjArBgsqhkiG9w0BCRACDDEcMBowGDAWBBTh14Ko4ZG+
# 72vKFpG1qrSUpiSb8zAvBgkqhkiG9w0BCQQxIgQgrZapb3Tj1Uiqv19TH4MdwrY/
# UxW/JmyWvNn7FAwTTw0wNwYLKoZIhvcNAQkQAi8xKDAmMCQwIgQgsxCQBrwK2YMH
# kVcp4EQDQVyD4ykrYU8mlkyNNXHs9akwDQYJKoZIhvcNAQEBBQAEggEAbewNFY9k
# j1KtUNJmqSd0E3tu9SfxTssvMZR7UCyfOign92tWUbpKZHI/2ebXTYbDICtVbkHy
# VMDUCf401V3MutGcAmU826tkIRpew1oabKSHOVmvjjQJNrN3IUj9AMeAS/qkRBeC
# htn16KX8DgorqqUCQGOQXkai9UCVUx5xSh5DBrVeuNF7sxXTHgcuiUv5GYJi6jyF
# SDdNcNY7ag5F9K/Fn5dEmjyJHhMfvmZLp2q1SQg3uUUNciWbLTyvLqihS1XDjAHW
# /uYdGihuWOrCsSOwStjtqesh3zXRKUgBPbRRFTbF6zHq1hH9MkKOdKqeEsVG7TMA
# 0X9lgwCmWL6w/A==
