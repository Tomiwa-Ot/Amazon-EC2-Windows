...
function ShouldEnableHibernation () {
  ...
  {
    Write-ErrorLog ("Metadata Check For Enabling Hibernation Failed: {0}" -f $_.Exception.Message)
    return $false
  }
}
...
function LogHibernationFailed () {
  ...
  Write-ErrorLog ("Failed to enable hibernation: {0}" -f $Message)
}
...
function RebindHibernateOnSleep () {
  ...
  Where-Object { $_.InstanceID -match $PowerSettingInstanceIdRegex }

  $planSleepSettings | ForEach-Object {
...
function Disable-HibernateOnSleep () {
  ...
  try
  {
    ...
    if (-not $enabledInfo[0]) {
      Write-ErrorLog ("Failed to disable hibernation: {0}" -f $enabledInfo[1])
      return
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBtRqe/QsNFmxAr
# POdIAeryvKLDZdAMIBkogZRgY3j3AKCCDlUwggawMIIEmKADAgECAhAIrUCyYNKc
...
# CQQxIgQg6maK57d0SOptGXZhg3WDIorsiIRQLF5jepnNYoecWvMwDQYJKoZIhvcN
# AQEBBQAEggGAWk0Gut9+17QXIaTtJs4Ay3lmAC6mGgTHSjKAwljGtrCZPRx3VwFd
# SlRJjEoRClxKP59T0XtQt74ccpvxoNUtxVIuLvbri7Z/qak+7N7fchg3o0zo0kvI
# +T7Wb/29MyDBEjWpqk990ayAe4gL4uydQC5FSKBUMI+WMl4j8cybmt2KAPqRFqO/
# KWPOJ5YlexksvJKbWYFpjndMsV5a120JB0HHnSzQBsZs/fBxlrxFXpwoxHCgHVhx
# hpnqWBz/ke5VoA41w4Uy4U4f0qjSe4h8DjmHyDQX49e2jvf8oaa9xtdAYtinFrmW
# ani/gdTRulozoITIxEN7bPoauF6mqzfWVL9TWF/YoLpvg3a06izDNlOZgx7IDPNu
# +ORnZ7O8XX63Qlrd5ZNafPc9KmtWGSAqB4JlF9K0X/ilhzyuLg0cyDKTkdMzDJ+d
# UJ1PS26zm1q8o+1HjjTjCOXfKapTC/wZukFRUixe4mAS0TQt22M0bXc1KPTNiJAa
# rIQDGiwq3lThoYINfjCCDXoGCisGAQQBgjcDAwExgg1qMIINZgYJKoZIhvcNAQcC
# oIINVzCCDVMCAQMxDzANBglghkgBZQMEAgEFADB4BgsqhkiG9w0BCRABBKBpBGcw
# ZQIBAQYJYIZIAYb9bAcBMDEwDQYJYIZIAWUDBAIBBQAEICpl03EuECxwpeFPVgv0
# bEQrVqYXLXXwWILpalws7oPEAhEAhJqX1Opu2lzejrjshb1UoRgPMjAyMjAxMzEx
# ODUwNDNaoIIKNzCCBP4wggPmoAMCAQICEA1CSuC+Ooj/YEAhzhQA8N0wDQYJKoZI
...
# MQ8XDTIyMDEzMTE4NTA0M1owKwYLKoZIhvcNAQkQAgwxHDAaMBgwFgQU4deCqOGR
# vu9ryhaRtaq0lKYkm/MwLwYJKoZIhvcNAQkEMSIEIO47qKmyUNW6XeSGh8zI0enh
# tW8leRksJdFnlJnMVHf4MDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEILMQkAa8CtmD
# B5FXKeBEA0Fcg+MpK2FPJpZMjTVx7PWpMA0GCSqGSIb3DQEBAQUABIIBAAZ5Ori/
# wgiwZFdqkUx0qanyPy+P09NvFiw9soHYGjwzSK9ECUb+5AcKQY1Ze3drATegBIla
# dxL4Ntxk6JuHO0AsIiDmHvfO6Th+iv43RxGGhkxtD6wP1k+TgiAp5IECetAMjh4G
# eoeZoXR/wop2IsG02Drp6M0L6jp3jyHOMAZBxcWv47uvcoGUu7ZYdEZvGMQI9FPD
# iJVoID0NSyV8ag5iwiLagUUQAyQtU39K6O+LBZiYRs5oBAWpzghRP4PO+kNa63by
# +lSAXNvmFnRePMqnXmsjxAimop7iUTa8xup75S1lT+dMCuO+NtZYjZ7FZmwwc4oA
# N2qUxhx7yrLjN50=
