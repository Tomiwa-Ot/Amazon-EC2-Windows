...
function Set-ComputerName
{
  ...
  try
  {
    ...
    {
      Write-ErrorLog "Invalid IP Address returned by metadata service!"
      return $false
    }
  ...
  {
    Write-ErrorLog ("Host Rename Failed. {0}" -f $_.Exception.Message)
  }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCBUz7TONhjRIbR
# WCgmVqFsPdCnXXDaYl4xiVUUQb663qCCDlUwggawMIIEmKADAgECAhAIrUCyYNKc
...
# CQQxIgQg6pK30lh8rIpsCWgPvv4vmEx4O6nivfNEwycU9eNfesgwDQYJKoZIhvcN
# AQEBBQAEggGAZcBXlUexbQqGQ6hVUjFAdRwIk4pKQcC+VsxiNjO3PEcnmwObLBsK
# dLUWvAnSLXZbeY56OGnmwP7tUFtq7Hs5z5WtqRV8H4ghkfHCj2O8ruquHBLq11vd
# dKM9iMy+iNlNZJjKU5x79m3Pj9A2SuUT5WWFbcRGu1n1AlhntnlkKSVZLTrUcEzG
# DB5yZ1jlqS5GheLY878NcPFyUXvlJYSMW5xpJzA3e++kesdKyJPfgJtd4INrOKuU
# CAk1rbsCw93nbSuSjs9NWN/324cr/f17uRnBzfRWTFaDQHKEyo5QzEgwKyhK7dNR
# tHyJK/qujUFCC2beP2uZI4nLDj8Wrx28VzdcUyX6GYDJaZjhwMjS9fMsyNkBm2/5
# P1g9sDg8REHsM7D2yIR16Hdv0VxWo3aO4yfSYXPpE5fYKyHkmwK5ejvA0pjafdKm
# 2WaP5oJKjg3SjdHPIawQQxaEJdeKiveVgrboUldpOXW6/gFa7P2UrkLXx0jSVHKq
# TYKRviSyWUu4oYINfjCCDXoGCisGAQQBgjcDAwExgg1qMIINZgYJKoZIhvcNAQcC
# oIINVzCCDVMCAQMxDzANBglghkgBZQMEAgEFADB4BgsqhkiG9w0BCRABBKBpBGcw
# ZQIBAQYJYIZIAYb9bAcBMDEwDQYJYIZIAWUDBAIBBQAEID7Gwsymr5Gv21vXjk0l
# FOT/4bJxy+ZkcQcjPJN8yEAWAhEA+ZrSeWKyE0ULNtRi7R8TPhgPMjAyMjAxMzEx
# ODUyNTlaoIIKNzCCBP4wggPmoAMCAQICEA1CSuC+Ooj/YEAhzhQA8N0wDQYJKoZI
...
# MQ8XDTIyMDEzMTE4NTI1OVowKwYLKoZIhvcNAQkQAgwxHDAaMBgwFgQU4deCqOGR
# vu9ryhaRtaq0lKYkm/MwLwYJKoZIhvcNAQkEMSIEIHJAicoz90hGCSSFZZH8G8bx
# iCODhM/K/pHl8IUlTEOkMDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEILMQkAa8CtmD
# B5FXKeBEA0Fcg+MpK2FPJpZMjTVx7PWpMA0GCSqGSIb3DQEBAQUABIIBAFVPfHQG
# gDPCbBv6sjw0wRMfSM6Suq6jSBTmEPYqiq0hx4dtbrsA7+TrRtScVfUPhjE14i83
# Gs0+4vJLG0nEReXN5+TN0x0EzyGJkUSHD45vvrQAr8W7FIa7HdSCdxaKw/R4bI7k
# LHJfqbZuu2BF3vmdhfz/wzmSg6kkpWKBlxf369jZbrqjOwT//+gcc43+LgFAZYxA
# sKFExEvgbYqELjcX+9PVwSMuSE0RNv83deqIHeq915ALQqCHoALhiBwazZH6tQJK
# ZtRaMRdr01gGwwOz8H1QNBsjfBfUdfX+25D/RSy8mAbbmZf2OKaYEDrtQoEcBHP+
# G8kqJsn7SbqF0dA=
