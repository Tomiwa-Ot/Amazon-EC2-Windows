...
function New-RandomPassword
{
  ...
  do
  {
    ...
    $password = [System.Text.Encoding]::ASCII.GetString(($randomBytes | Where-Object { `
    ...
    # Passwords must have a length of >= 32
    ...
    # Passwords must contain characters from three of the four categories
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBhoNs/8x0r+EDs
# hzR061flgrFTF2U5WIDXHb5wHrgwuqCCDlUwggawMIIEmKADAgECAhAIrUCyYNKc
...
# CQQxIgQgKg3n7VAwznaPnfdM0g73kP1iT9QCkunxBDY8rJNU7yswDQYJKoZIhvcN
# AQEBBQAEggGASSiiJSf2e3akPpinRMwHZRbANOMynvOrHCEcOkDCHbqjg2Y/GZFv
# AZDpdV00sLHBbearZFeB799H4bQWOC5IRwrvz9e3r9nL13gHqAVpGsC3jz7BExul
# rM9pNk6sIhMRB3wau4b5SCV1ID2TI0nqpH4feSuK+sSbLPOh/Jry+QVBak3CA+cI
# OTIkVkEXpXGsVG52yb55vskbjDv0OFvO7imt/t7NMOYmeuVRvTKbMiihTykmDgXB
# VKvD1ziy7uMmaM8yPknf1XvRYAWHg/62vIKMbIxmktgeUFG4Vnd5t0L4v5GwIO6R
# wic0j9sY5s6Mf0wJRYzSVA+YomODp6gxptL4i28bTYP4yfC2S8t3UPN5q9ubyjsr
# pjbkuaRdc9lYY5GWCGAMIf/gx8/Wzbf6AZVb74JJqoYrn5HPK+EV+0c8zz5tgH7l
# nHA+smNILhAMBJ2mjKj4D/OpxF7vzoBPMGXZCg2P2ZmZpgxIY0xsz189CEFgm3uC
# S8GAhlOTQhI9oYINfjCCDXoGCisGAQQBgjcDAwExgg1qMIINZgYJKoZIhvcNAQcC
# oIINVzCCDVMCAQMxDzANBglghkgBZQMEAgEFADB4BgsqhkiG9w0BCRABBKBpBGcw
# ZQIBAQYJYIZIAYb9bAcBMDEwDQYJYIZIAWUDBAIBBQAEICWLKre8tBJ/SebLKZTc
# cM+MEe67cdqirurlDN6/i6K0AhEAk7UpnGvPmDLVi49TSE/AwRgPMjAyMjAxMzEx
# ODQ4NTdaoIIKNzCCBP4wggPmoAMCAQICEA1CSuC+Ooj/YEAhzhQA8N0wDQYJKoZI
...
# MQ8XDTIyMDEzMTE4NDg1N1owKwYLKoZIhvcNAQkQAgwxHDAaMBgwFgQU4deCqOGR
# vu9ryhaRtaq0lKYkm/MwLwYJKoZIhvcNAQkEMSIEINtjIYzHxYKRuot4ue+LAikV
# 2lMpNQgjEkeuDdp6OQRUMDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEILMQkAa8CtmD
# B5FXKeBEA0Fcg+MpK2FPJpZMjTVx7PWpMA0GCSqGSIb3DQEBAQUABIIBAEVvwaFI
# onJyHQp75DKtpD6S2/u/qun5BZ2dDQmcTVkKmB7bZhEd8CRTsIebDaoRpRlr0zOf
# ZzFtvkLosE6OcdE/46BUUPOwwUk+MpzRd6mZjUVMQ3EezgI7I8UqK5FAHqZ56R7D
# EUhi/apL/jTKmJ5LW4JB0YPQC6r/8aMFURn6mrHXH1DYBcJwf1iJROQwKtlhJr3W
# rWJOzZPvmUwXxKUQ68b8pB0Iew+hEmS4/EaaLW2vcdbfWMs4Z5tU7ib9uDFiwgL0
# Bp2r5qGhc8ZcKdWN2XkybFtgPowxBV9v37b+clmHlrAL7pHkpF+FhlcAKlA/ZpAL
# FDYCzlGMFoTrcpM=
