...
function Get-BlockDriveMapping
{
  ...
  {
    Write-ErrorLog ("Failed to get block-device-mapping info from metadata")
  }
  ...
  foreach ($disk in $disks)
  {
    ...
    {
      Write-ErrorLog ("Failed to get block-device-mapping for disk {0} from metadata" -f $disk)
      continue
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAIqvV2YWTNP3Et
# UuKvEtpOyJ3ANde1OfgHnFJHZ7LwoaCCDlUwggawMIIEmKADAgECAhAIrUCyYNKc
...
# CQQxIgQg9whvdp8SGUgXgRY61aT60YvVuf5M1EfL+9W1765SbEQwDQYJKoZIhvcN
# AQEBBQAEggGAB/qo+/PqXCPdNiAhMhFZBUhkaLxWWqweUSTSOFf7iolSQ0ApYn6S
# vLO28BreQGUJAiQUo1B6cqaPGjtUAP8FZ5weKb5bCtSfanqgN3O5TCV7Ds7WHeBP
# 73zVNilZGaohkanOvpLQX+ZZSW2xsQ8kGjYIGLtEyku6N5bMH0z74xtDBvDRVzu7
# leF1jk3k/vRNmMKeWVqROy+RxOCJJVdvOL9zUdlgeP/dObLwOrVv6fMv4C8vyepb
# vtNfUxVfi3NWgV+Te+6zSsNvupvggwBzopI9agPHVDhGHrjl5Wz8Z0GEeU1GSNde
# IYxO91qy3YY0n0vaQs5F1IlbYeVDPLFCOjP0KVJCDt0xT9B8DtnQhyBAYDnoJRCP
# 8Q+tg2xNpxh+YGhcZjsIBXWxt38Tma6Nc/3nDOZNBBboxVtkUgyQQwyH3vn5a3cE
# VcU73uiudcydnti2osBXqdgICEAkl8hbG5LEP2aKX1weDPUFal8XgAwisNXZPReP
# VBR0TfdNp6IfoYINfTCCDXkGCisGAQQBgjcDAwExgg1pMIINZQYJKoZIhvcNAQcC
# oIINVjCCDVICAQMxDzANBglghkgBZQMEAgEFADB3BgsqhkiG9w0BCRABBKBoBGYw
# ZAIBAQYJYIZIAYb9bAcBMDEwDQYJYIZIAWUDBAIBBQAEILP+U2Bv8TIZVmDaZtaQ
# LxA0TCroRQwrsUPHyDEKQZ3ZAhBaNdKK+tLX9MIa6iGifljAGA8yMDIyMDEzMTE4
# NDk1M1qgggo3MIIE/jCCA+agAwIBAgIQDUJK4L46iP9gQCHOFADw3TANBgkqhkiG
...
# DxcNMjIwMTMxMTg0OTUzWjArBgsqhkiG9w0BCRACDDEcMBowGDAWBBTh14Ko4ZG+
# 72vKFpG1qrSUpiSb8zAvBgkqhkiG9w0BCQQxIgQgjGhQ6NWEMEX3TH3L9zA9/Pmy
# NxduwSdPFCi1WuPb+r4wNwYLKoZIhvcNAQkQAi8xKDAmMCQwIgQgsxCQBrwK2YMH
# kVcp4EQDQVyD4ykrYU8mlkyNNXHs9akwDQYJKoZIhvcNAQEBBQAEggEAUHIcOW1L
# S3fkSR+h9i9LEC7B3WNQ0PrZRuIub0ahtkoBrPBs8Et/+xiDYLxtFgOGTjsp+esb
# BhvAmJjDDuOzrrh/UjpRBOIPL/gDyMb1PwzZ4USNm+i6gA0JiZrtrQcMkqyEepRf
# 26xLy5c0PzkjPGpg8x61ChrivOPail/oZGEM5kfBXD4ZqMSqRgbxZRf526tR5dKR
# nAaR5hQReeBs4RpTUd5iyIM485+HMI9+DoP5m6jeFu4qOnL5m6e+5s3D24fNJmeN
# kWsxF9l7ioNqsAuAfMl1G6TUh8QRO/mc7NPfYFCh1zgrmahnFJJJYgCUHMLMwO8y
# UjT3KPbiIjbWKA==
