...
function Set-ActivationSettings
{
  ...
  if (Test-Path $licenseServiceKeyReg)
  {
    ...
    {
      Write-ErrorLog ("Failed to set activation settings: {0}" -f $_.Exception.Message)
    }
  }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDOKwm6ncJ9GTqP
# mX+hu66O/0LjyIbRT8esqGvoixgZPqCCDlUwggawMIIEmKADAgECAhAIrUCyYNKc
...
# CQQxIgQghWMyW7WnA39NoTuVKkwZhRS10rzF7GXgS3jBugamry4wDQYJKoZIhvcN
# AQEBBQAEggGAWZUViwhHMD4PekVNHA1PMgrj3Zzv7gbmyCQ6rAUBTKy3mI0mobVw
# DtDszVUvuwUIgJZq++Mk4dar+5EqEinc8JqNoUlAbGuq7+nYWLSb+mWRjEvrUWox
# fGDmF5YkN0UczKluWddZ/IOesMWSGA7stgywowOufWRMpQedqq7mfWe+XE3LR7yl
# bKzrEhXRxAFAMwFZF/VFO2nYBQS2yUEaV+HwWaNDQHW8htCVhCieC22pzwUFxXwu
# KnuHnQL19O+VUo8E2fntCOPxxWrNjCMbYJXkBSf6MkSPfOeTPQQGTuqczBdexwy2
# sIlJrtfLlRRh/eeW+wpUDA0QacDsfBCCTt9vM5XuAcUfoJh53wHt1Eb8Y+gMe7zy
# pXwRGRL0LBBmGb3mNhRRRyoIJIB1EqvasoF6vcRRjm6snitiWZnCfry1wAfWUr1E
# 7j8aVyd15B/kl9agZjTIrdfZb/kiVse49mYjQjtOyMznj+dbyEJ5ImSLF16qoq2S
# 5S8RTpNIW3CdoYINfTCCDXkGCisGAQQBgjcDAwExgg1pMIINZQYJKoZIhvcNAQcC
# oIINVjCCDVICAQMxDzANBglghkgBZQMEAgEFADB3BgsqhkiG9w0BCRABBKBoBGYw
# ZAIBAQYJYIZIAYb9bAcBMDEwDQYJYIZIAWUDBAIBBQAEIDsbTwFYj+mWSkEbMwwX
# mylTnBdR9xuP5NCL9QKP6e3lAhBEq2RmcMEttRt4w+jNPWDoGA8yMDIyMDEzMTE4
# NTA0OVqgggo3MIIE/jCCA+agAwIBAgIQDUJK4L46iP9gQCHOFADw3TANBgkqhkiG
...
# DxcNMjIwMTMxMTg1MDQ5WjArBgsqhkiG9w0BCRACDDEcMBowGDAWBBTh14Ko4ZG+
# 72vKFpG1qrSUpiSb8zAvBgkqhkiG9w0BCQQxIgQgS7rPGZWMaK7iGFbVIqPTTY9g
# dc3G9q+b/CQmWcGQGdkwNwYLKoZIhvcNAQkQAi8xKDAmMCQwIgQgsxCQBrwK2YMH
# kVcp4EQDQVyD4ykrYU8mlkyNNXHs9akwDQYJKoZIhvcNAQEBBQAEggEAgza2Bdgu
# f/sDal4nHM6eVNnIPHoz/1nBRLzA7x1+ie9AOkGpFkTDmEYhmIxesfyEZvLZwbBK
# h9dSR/4A8rIp2GLhAyJyMplnw6Oj+htFwcWAZ50eV3J6EWWXFHu7V7033d1xfR/p
# ZexPpp0n+5WG7iV51ZFbbHGOl/nfYv6GkctYvbb/hyMcmDHfat9Shh8qSlGuihvP
# mEVkNN5bzp3ETmutWpqVkZMdpJo3ZqAA8MWJfgzP1YTVo2Xf9qUxW3xAOZDxiMA0
# EU0lKpS/hl++kx/TLaJGG6sT/j6cEvGoGqmy/x0CiqNjfd2OI00yTcPulczhqvTD
# q9k132ttulrHmg==
